...
By default, ciscoisesdk will look for the following environment variables to create new connection objects:
    ...
    * ``IDENTITY_SERVICES_ENGINE_VERSION`` - Identity Services Engine API version to use. Defaults to '3.3_patch_1'.
...
.. code-block:: python
    ...
    VersionError: Unknown API version, known versions are 3.1.0, 3.1.1, 3.1_Patch_1, 3.2_beta and 3.3_patch_1.
...
.. code-block:: python
    ...
    >>> from ciscoisesdk import IdentityServicesEngineAPI
    >>> # Create a IdentityServicesEngineAPI connection object;
    >>> # Using encoded_auth, with Identity Services Engine API version 3.3_patch_1
    ...
    >>> # Create a IdentityServicesEngineAPI connection object;
    >>> # Using username, and password, with ISE API version 3.3_patch_1
...
.. code-block:: python
    ...
    >>> kingston_api = IdentityServicesEngineAPI(encoded_auth=kingston_auth, base_url="https://dcloud-dna-ise-rtp.cisco.com", version='3.3_patch_1')
    >>> london_api = IdentityServicesEngineAPI(*london_auth, base_url="https://128.107.71.199:443",
    ...                                        version='3.3_patch_1', uses_api_gateway=True)  # * Unpacks tuple
...
.. code-block:: python
    ...
    >>> from ciscoisesdk import IdentityServicesEngineAPI
    >>> # Create a IdentityServicesEngineAPI connection object;
    >>> # it uses Identity Services Engine username and password, with ISE API version 3.3_patch_1
...
.. code-block:: python
    ...
    ... base_url="https://128.107.71.199:443", version='3.3_patch_1', uses_api_gateway=True)
...
+ :ref:`v3.3_patch_1 <v3_3_patch_1 summary>`
...
.. code-block:: python
    ...
    # Create a IdentityServicesEngineAPI connection object;
    # it uses Identity Services Engine sandbox URL, username and password, with Identity Services Engine API version 3.3_patch_1.,

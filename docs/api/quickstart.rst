...
.. code-block:: python
    ...
    >>> api.network_access_policy_set.get_network_access_policy_set_list().response.response
    [{'default': False,
...
.. code-block:: python
    ...
    >>> policy_set = api.network_access_policy_set.get_network_access_policy_set_list().response.response
    >>> policy_set[0].id

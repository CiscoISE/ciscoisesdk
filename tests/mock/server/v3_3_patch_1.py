...
class MockServerRequestHandler_v3_3_patch_1(BaseHTTPRequestHandler):
    SGT_RANGE_RESERVATION_ab239b1cb373585dab8b3d2a1755096a_PATTERN = re.compile(r"/api/v1/sgt/reservation")
    SGT_RANGE_RESERVATION_3c565815d18a5b2bbc5f64f935d322f1_PATTERN = re.compile(r"/api/v1/sgt/reservation/reserveRange")
    SGT_RANGE_RESERVATION_8955cf7b3b15569893114af795c1e8e2_PATTERN = re.compile(r"/api/v1/sgt/reservation/string")
    SGT_RANGE_RESERVATION_90c8c7bb726f53e7be3a2023aa3dda80_PATTERN = re.compile(r"/api/v1/sgt/reservation/string")
    SGT_RANGE_RESERVATION_086ca7d6274e5090be92eccb6facea16_PATTERN = re.compile(r"/api/v1/sgt/reservation/string")
    SUBSCRIBER_bb725fc737535a23b2459a255a4b9725_PATTERN = re.compile(r"/api/v1/fiveg/subscriber")
    SUBSCRIBER_3083c9ea8f91504d9aa46ebd90dd1ab4_PATTERN = re.compile(r"/api/v1/fiveg/subscriber")
    SUBSCRIBER_2bf1dfb9226e534cb039880148e47e95_PATTERN = re.compile(r"/api/v1/fiveg/subscriber/string")
    SUBSCRIBER_cfc8b401a45650b386d0ae88c2ac3ef4_PATTERN = re.compile(r"/api/v1/fiveg/subscriber/string")
    SUBSCRIBER_ce70db8b014a599d8b6d623c4713b176_PATTERN = re.compile(r"/api/v1/fiveg/subscriber/string")
    SUBSCRIBER_a1b71359fd0351f3a7f824ce8c4df14a_PATTERN = re.compile(r"/api/v1/fiveg/subscriber/imsi/string")
    SUBSCRIBER_ee509b9ea4465d33bcb6552b30ec32b6_PATTERN = re.compile(r"/api/v1/fiveg/subscriber/bulk")
    USER_EQUIPMENT_b5d936170e535fb5a2e6742807081bb5_PATTERN = re.compile(r"/api/v1/fiveg/user-equipment")
    USER_EQUIPMENT_6a2770b9fac658769ca2c63ca6984b9e_PATTERN = re.compile(r"/api/v1/fiveg/user-equipment")
    USER_EQUIPMENT_b15aa7a86eb25690b0306e29e0acdc9d_PATTERN = re.compile(r"/api/v1/fiveg/user-equipment/string")
    USER_EQUIPMENT_cf803097098c5553a2f1e5ae0c526da5_PATTERN = re.compile(r"/api/v1/fiveg/user-equipment/string")
    USER_EQUIPMENT_ebecb7076ea45c289951b77ba6de7508_PATTERN = re.compile(r"/api/v1/fiveg/user-equipment/string")
    USER_EQUIPMENT_d990d821a0885cc2a002144e1fa1a7eb_PATTERN = re.compile(r"/api/v1/fiveg/user-equipment/subscriber/string")
    USER_EQUIPMENT_b97cb90bda30562198f19eb20a343d2a_PATTERN = re.compile(r"/api/v1/fiveg/user-equipment/imei/string")
    USER_EQUIPMENT_06bc5a2ced485ac2a06f77d7cc36ee20_PATTERN = re.compile(r"/api/v1/fiveg/user-equipment/csv")
    USER_EQUIPMENT_79a3bd66e4d75f5f99198a5999e596a8_PATTERN = re.compile(r"/api/v1/fiveg/user-equipment/bulk")
    ...
    CUSTOM_ATTRIBUTES_70a02a1af2b156c8b040d628e59f86e9_PATTERN = re.compile(r"/api/v1/endpoint-custom-attribute")
    CUSTOM_ATTRIBUTES_da31003b02f4519eaa18073aa1b85cee_PATTERN = re.compile(r"/api/v1/endpoint-custom-attribute")
    CUSTOM_ATTRIBUTES_019ebd4481045cdb92a3d380f1c0237e_PATTERN = re.compile(r"/api/v1/endpoint-custom-attribute/rename")
    CUSTOM_ATTRIBUTES_bef8c77f8d035a44a5c250db397dd59a_PATTERN = re.compile(r"/api/v1/endpoint-custom-attribute/string")
    CUSTOM_ATTRIBUTES_bd6f3a50e58459b1b7f735dce452c9b2_PATTERN = re.compile(r"/api/v1/endpoint-custom-attribute/string")
    DATACONNECT_SERVICES_d98458307a1c5cea9b11ee96945fcefa_PATTERN = re.compile(r"/api/v1/mnt/data-connect/details")
    DATACONNECT_SERVICES_e0455a6b0945530585c7a32f36ae76b0_PATTERN = re.compile(r"/api/v1/mnt/data-connect/settings")
    DATACONNECT_SERVICES_709687a7458c54ed9f4761c46a3c5e58_PATTERN = re.compile(r"/api/v1/mnt/data-connect/settings/password")
    DATACONNECT_SERVICES_550974fed9705442857aa0fee26a7a62_PATTERN = re.compile(r"/api/v1/mnt/data-connect/settings/password/expiry")
    DATACONNECT_SERVICES_b1b4aa6b58875e0cb90805def240b058_PATTERN = re.compile(r"/api/v1/mnt/data-connect/settings/status")
    ...
    AD_GROUPS_d9932860667c5586a9984568d5d8223b_PATTERN = re.compile(r"/api/v1/duo-identitysync/adgroups/string")
    ACTIVE_DIRECTORIES_411653fa59ab523b87f9d89c16fc5f7b_PATTERN = re.compile(r"/api/v1/duo-identitysync/activedirectories")
    DUO_IDENTITY_SYNC_1df181ea3dcd56bfbe7f79ff573b5fc2_PATTERN = re.compile(r"/api/v1/duo-identitysync/identitysync")
    DUO_IDENTITY_SYNC_69373c868f315159b4ba2bc7682c7887_PATTERN = re.compile(r"/api/v1/duo-identitysync/identitysync")
    DUO_IDENTITY_SYNC_1076d1e5dabd543288df5173b39fb8cf_PATTERN = re.compile(r"/api/v1/duo-identitysync/identitysync/status/string")
    DUO_IDENTITY_SYNC_19763764ea97590ebf96ed2ccce5e19c_PATTERN = re.compile(r"/api/v1/duo-identitysync/identitysync/sync/cancel/string")
    DUO_IDENTITY_SYNC_e23a28af8006509c85271e07d522a12e_PATTERN = re.compile(r"/api/v1/duo-identitysync/identitysync/sync/string")
    DUO_IDENTITY_SYNC_4eceed7a4795587b812ca7d4fb71c1ad_PATTERN = re.compile(r"/api/v1/duo-identitysync/identitysync/string")
    DUO_IDENTITY_SYNC_28cd01786a6f5573be19bbd17a7a2561_PATTERN = re.compile(r"/api/v1/duo-identitysync/identitysync/string")
    DUO_IDENTITY_SYNC_7a957abe42fe5ec4ba32c71309d30c12_PATTERN = re.compile(r"/api/v1/duo-identitysync/identitysync/string")
    ENDPOINT_STOP_REPLICATION_SERVICE_c99b06123cb958fb91d7581457e28ca1_PATTERN = re.compile(r"/api/v1/stop-replication")
    ENDPOINT_STOP_REPLICATION_SERVICE_bdc839ed309b593d8e7b8a90ef5930c5_PATTERN = re.compile(r"/api/v1/stop-replication")
    NATIVE_IPSEC_23993d9fe5cd54278a69cb1b5c800c32_PATTERN = re.compile(r"/api/v1/ipsec")
    NATIVE_IPSEC_5d4fb0706d0f5226b8691538a2bc7309_PATTERN = re.compile(r"/api/v1/ipsec")
    NATIVE_IPSEC_289ef20d5d63551dbe25878007747598_PATTERN = re.compile(r"/api/v1/ipsec")
    NATIVE_IPSEC_eca8a69196d555a1b7e71cf190bd2641_PATTERN = re.compile(r"/api/v1/ipsec/bulk")
    NATIVE_IPSEC_3a5e87f906e357bcb972c60ee082d89b_PATTERN = re.compile(r"/api/v1/ipsec/certificates")
    NATIVE_IPSEC_4f159a76b6aa52c2b0d0a2fe31dcae91_PATTERN = re.compile(r"/api/v1/ipsec/disable/string/string")
    NATIVE_IPSEC_2b57a1b126cb53ed8533eb22db13719d_PATTERN = re.compile(r"/api/v1/ipsec/enable/string/string")
    NATIVE_IPSEC_208a5dd6bd055c73bc02c8a389fd353f_PATTERN = re.compile(r"/api/v1/ipsec/string/string")
    NATIVE_IPSEC_9f2a9c1f22035982beaa10f027814d01_PATTERN = re.compile(r"/api/v1/ipsec/string/string")
    ...
    CONFIGURATION_c745aa263c5058f0a4e9f6b506954df9_PATTERN = re.compile(r"/api/v1/lsd/updateLsdSettings")
    CONFIGURATION_9292140052ab58f0809a3eb6e7561714_PATTERN = re.compile(r"/api/v1/lsd/updateLsdSettings")
    DUO_MFA_f1841c8263105468a0e51fc4751ba6dc_PATTERN = re.compile(r"/api/v1/duo-mfa/mfa")
    DUO_MFA_45dcf17da7955cee9028a267873d055f_PATTERN = re.compile(r"/api/v1/duo-mfa/mfa")
    DUO_MFA_4fb47bc0b25f53b093b356d41f1c59ab_PATTERN = re.compile(r"/api/v1/duo-mfa/mfa/testconnection/string")
    DUO_MFA_72fe75e2be3e56c9836c9c0db3a4be20_PATTERN = re.compile(r"/api/v1/duo-mfa/mfa/string")
    DUO_MFA_803320e8eb885d7cb70656383f03864f_PATTERN = re.compile(r"/api/v1/duo-mfa/mfa/string")
    DUO_MFA_bec78a0adabd51a7bb03a74616b7b501_PATTERN = re.compile(r"/api/v1/duo-mfa/mfa/string")
    ENABLE_MFA_c4928172faa15fe796dfb42c01705007_PATTERN = re.compile(r"/api/v1/duo-mfa/enable")
    IS_MFA_ENABLED_fbd6ee3b38595e79b3a6b06bf7a3439a_PATTERN = re.compile(r"/api/v1/duo-mfa/status")
    ...
    PX_GRID_DIRECT_318d1004b4485c06871c0c86358068cb_PATTERN = re.compile(r"/api/v1/pxgrid-direct/connector-config")
    PX_GRID_DIRECT_af9c8ad00e925e6885c3b3167dbdb4a3_PATTERN = re.compile(r"/api/v1/pxgrid-direct/connector-config")
    PX_GRID_DIRECT_9994d4fedcc553a3966efb225bd927c6_PATTERN = re.compile(r"/api/v1/pxgrid-direct/connector-config/string")
    PX_GRID_DIRECT_87dbcbf6ee965b90a47c157c87efef5f_PATTERN = re.compile(r"/api/v1/pxgrid-direct/connector-config/string")
    PX_GRID_DIRECT_87dbb36cd7f25770b884da5053decff4_PATTERN = re.compile(r"/api/v1/pxgrid-direct/connector-config/string")
    PX_GRID_DIRECT_851a85e09e275340b9c39f9f0cc77902_PATTERN = re.compile(r"/api/v1/pxgrid-direct/dictionary-references")
    PX_GRID_DIRECT_059f5ea29c9654f99a341aff1c064f9b_PATTERN = re.compile(r"/api/v1/pxgrid-direct/syncNowStatus/string")
    PX_GRID_DIRECT_a83fbc2fed26547b964c13e5771038f7_PATTERN = re.compile(r"/api/v1/pxgrid-direct/syncnow")
    PX_GRID_DIRECT_d4ff0e7ffab4526fbdb811b264bba36d_PATTERN = re.compile(r"/api/v1/pxgrid-direct/test-connector")
    ...
    FULL_UPGRADE_6a8cb91a4f09598bbdfa6c4b146c2763_PATTERN = re.compile(r"/api/v1/upgrade/prepare/get-status")
    FULL_UPGRADE_aa612059ca395d97922d045b42c75fcc_PATTERN = re.compile(r"/api/v1/upgrade/prepare/pre-checks")
    FULL_UPGRADE_15572010b4b951fa8ed4a6e4da1a5696_PATTERN = re.compile(r"/api/v1/upgrade/proceed/get-status")
    FULL_UPGRADE_22d4d90ae0435f3fa638b6b4f206b5a6_PATTERN = re.compile(r"/api/v1/upgrade/proceed/initiate-upgrade")
    FULL_UPGRADE_1255607ea018583db18166b743662136_PATTERN = re.compile(r"/api/v1/upgrade/stage/cancel-stage")
    FULL_UPGRADE_de4f26345bf95460b81cfce5395e989c_PATTERN = re.compile(r"/api/v1/upgrade/stage/get-status")
    FULL_UPGRADE_0d78612f495d584a8a941677e9194f35_PATTERN = re.compile(r"/api/v1/upgrade/stage/start-stage")
    FULL_UPGRADE_2c8ccef8538b5c3892d8e9211faa051f_PATTERN = re.compile(r"/api/v1/upgrade/summary/get-status")
    ...
    ENDPOINTS_33977733578154648184bcb37d211030_PATTERN = re.compile(r"/api/v1/endpoint")
    ENDPOINTS_5175a51ed0d2536b9df3968e4773abe6_PATTERN = re.compile(r"/api/v1/endpoint")
    ENDPOINTS_e076428d49535723a07a5bbcbcbd128d_PATTERN = re.compile(r"/api/v1/endpoint/bulk")
    ENDPOINTS_64dcda215550553980db1cd60c7314a7_PATTERN = re.compile(r"/api/v1/endpoint/bulk")
    ENDPOINTS_0d43c525d23b5c4bba03a0c774d4d411_PATTERN = re.compile(r"/api/v1/endpoint/bulk")
    ENDPOINTS_689e06db5cda5ba7b82f14cbd46d262c_PATTERN = re.compile(r"/api/v1/endpoint/deviceType/summary")
    ENDPOINTS_f190d005d391514e97e04abe777a25f6_PATTERN = re.compile(r"/api/v1/endpoint/string")
    ENDPOINTS_ced9c2b976d053d898d9867def5eef28_PATTERN = re.compile(r"/api/v1/endpoint/string")
    ENDPOINTS_71de74c081ab537aadfcb4843f33e4c7_PATTERN = re.compile(r"/api/v1/endpoint/string")
    ENDPOINTS_35a7b96eb91052e49e6fc7bfc499ba5f_PATTERN = re.compile(r"/api/v1/endpointTask")
    ...
    def matches_SGT_RANGE_RESERVATION_ab239b1cb373585dab8b3d2a1755096a(self):
        return re.search(
            self.SGT_RANGE_RESERVATION_ab239b1cb373585dab8b3d2a1755096a_PATTERN,
            self.path
        )

    def sgt_range_reservation_get_sgt_reserved_ranges_response(self):
        ...
        response_content = json.dumps({'response': [{'clientId': 'string', 'clientName': 'string', 'endIndex': 0, 'startIndex': 0}], 'version': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return

    def matches_SGT_RANGE_RESERVATION_3c565815d18a5b2bbc5f64f935d322f1(self):
        return re.search(
            self.SGT_RANGE_RESERVATION_3c565815d18a5b2bbc5f64f935d322f1_PATTERN,
            self.path
        )

    def sgt_range_reservation_reserve_sgt_range_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_SGT_RANGE_RESERVATION_8955cf7b3b15569893114af795c1e8e2(self):
        return re.search(
            self.SGT_RANGE_RESERVATION_8955cf7b3b15569893114af795c1e8e2_PATTERN,
            self.path
        )

    def sgt_range_reservation_get_sgt_reserved_range_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_SGT_RANGE_RESERVATION_90c8c7bb726f53e7be3a2023aa3dda80(self):
        return re.search(
            self.SGT_RANGE_RESERVATION_90c8c7bb726f53e7be3a2023aa3dda80_PATTERN,
            self.path
        )

    def sgt_range_reservation_update_reserved_range_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_SGT_RANGE_RESERVATION_086ca7d6274e5090be92eccb6facea16(self):
        return re.search(
            self.SGT_RANGE_RESERVATION_086ca7d6274e5090be92eccb6facea16_PATTERN,
            self.path
        )

    def sgt_range_reservation_delete_sgt_reserve_range_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_SUBSCRIBER_bb725fc737535a23b2459a255a4b9725(self):
        return re.search(
            self.SUBSCRIBER_bb725fc737535a23b2459a255a4b9725_PATTERN,
            self.path
        )

    def subscriber_get_all_subscribers_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'response': [{'enabled': True, 'friendlyName': 'string', 'identityGroups': 'string', 'imeis': 'string', 'opc': 'string', 'ki': 'string', 'imsi': 'string', 'createTime': 'string', 'updateTime': 'string', 'id': 'string', 'link': {'rel': 'string', 'href': 'string', 'type': 'string'}}], 'nextPage': {'rel': 'string', 'href': 'string', 'type': 'string'}, 'previousPage': {'rel': 'string', 'href': 'string', 'type': 'string'}, 'version': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return

    def matches_SUBSCRIBER_3083c9ea8f91504d9aa46ebd90dd1ab4(self):
        return re.search(
            self.SUBSCRIBER_3083c9ea8f91504d9aa46ebd90dd1ab4_PATTERN,
            self.path
        )

    def subscriber_create_subscriber_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_SUBSCRIBER_2bf1dfb9226e534cb039880148e47e95(self):
        return re.search(
            self.SUBSCRIBER_2bf1dfb9226e534cb039880148e47e95_PATTERN,
            self.path
        )

    def subscriber_get_subscriber_by_id_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_SUBSCRIBER_cfc8b401a45650b386d0ae88c2ac3ef4(self):
        return re.search(
            self.SUBSCRIBER_cfc8b401a45650b386d0ae88c2ac3ef4_PATTERN,
            self.path
        )

    def subscriber_update_subscriber_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_SUBSCRIBER_ce70db8b014a599d8b6d623c4713b176(self):
        return re.search(
            self.SUBSCRIBER_ce70db8b014a599d8b6d623c4713b176_PATTERN,
            self.path
        )

    def subscriber_delete_subscriber_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_SUBSCRIBER_a1b71359fd0351f3a7f824ce8c4df14a(self):
        return re.search(
            self.SUBSCRIBER_a1b71359fd0351f3a7f824ce8c4df14a_PATTERN,
            self.path
        )

    def subscriber_get_subscriber_by_i_m_s_i_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_SUBSCRIBER_ee509b9ea4465d33bcb6552b30ec32b6(self):
        return re.search(
            self.SUBSCRIBER_ee509b9ea4465d33bcb6552b30ec32b6_PATTERN,
            self.path
        )

    def subscriber_bulk_subscriber_operation_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_USER_EQUIPMENT_b5d936170e535fb5a2e6742807081bb5(self):
        return re.search(
            self.USER_EQUIPMENT_b5d936170e535fb5a2e6742807081bb5_PATTERN,
            self.path
        )

    def user_equipment_get_user_equipments_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'response': [{'description': 'string', 'deviceGroup': 'string', 'imei': 'string', 'createTime': 'string', 'updateTime': 'string', 'id': 'string', 'link': {'rel': 'string', 'href': 'string', 'type': 'string'}}], 'nextPage': {'rel': 'string', 'href': 'string', 'type': 'string'}, 'previousPage': {'rel': 'string', 'href': 'string', 'type': 'string'}, 'version': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return

    def matches_USER_EQUIPMENT_6a2770b9fac658769ca2c63ca6984b9e(self):
        return re.search(
            self.USER_EQUIPMENT_6a2770b9fac658769ca2c63ca6984b9e_PATTERN,
            self.path
        )

    def user_equipment_create_user_equipment_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_USER_EQUIPMENT_b15aa7a86eb25690b0306e29e0acdc9d(self):
        return re.search(
            self.USER_EQUIPMENT_b15aa7a86eb25690b0306e29e0acdc9d_PATTERN,
            self.path
        )

    def user_equipment_get_user_equipment_by_id_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_USER_EQUIPMENT_cf803097098c5553a2f1e5ae0c526da5(self):
        return re.search(
            self.USER_EQUIPMENT_cf803097098c5553a2f1e5ae0c526da5_PATTERN,
            self.path
        )

    def user_equipment_update_user_equipment_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_USER_EQUIPMENT_ebecb7076ea45c289951b77ba6de7508(self):
        return re.search(
            self.USER_EQUIPMENT_ebecb7076ea45c289951b77ba6de7508_PATTERN,
            self.path
        )

    def user_equipment_delete_user_equipment_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_USER_EQUIPMENT_d990d821a0885cc2a002144e1fa1a7eb(self):
        return re.search(
            self.USER_EQUIPMENT_d990d821a0885cc2a002144e1fa1a7eb_PATTERN,
            self.path
        )

    def user_equipment_get_user_equipments_by_subscriber_id_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'response': [{'description': 'string', 'deviceGroup': 'string', 'imei': 'string', 'createTime': 'string', 'updateTime': 'string', 'id': 'string', 'link': {'rel': 'string', 'href': 'string', 'type': 'string'}}], 'version': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return

    def matches_USER_EQUIPMENT_b97cb90bda30562198f19eb20a343d2a(self):
        return re.search(
            self.USER_EQUIPMENT_b97cb90bda30562198f19eb20a343d2a_PATTERN,
            self.path
        )

    def user_equipment_get_user_equipment_by_i_m_e_i_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_USER_EQUIPMENT_06bc5a2ced485ac2a06f77d7cc36ee20(self):
        return re.search(
            self.USER_EQUIPMENT_06bc5a2ced485ac2a06f77d7cc36ee20_PATTERN,
            self.path
        )

    def user_equipment_create_user_equipments_from_c_s_v_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_USER_EQUIPMENT_79a3bd66e4d75f5f99198a5999e596a8(self):
        return re.search(
            self.USER_EQUIPMENT_79a3bd66e4d75f5f99198a5999e596a8_PATTERN,
            self.path
        )

    def user_equipment_bulk_user_equipment_operation_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def certificates_get_csr_by_id_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'response': {'csrContents': 'string', 'friendlyName': 'string', 'groupTag': 'string', 'hostName': 'string', 'id': 'string', 'keySize': 'string', 'link': {'href': 'string', 'rel': 'string', 'type': 'string'}, 'sanNames': 'string', 'signatureAlgorithm': 'string', 'subject': 'string', 'timeStamp': 'string', 'usedFor': 'string'}, 'version': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def matches_CUSTOM_ATTRIBUTES_70a02a1af2b156c8b040d628e59f86e9(self):
        return re.search(
            self.CUSTOM_ATTRIBUTES_70a02a1af2b156c8b040d628e59f86e9_PATTERN,
            self.path
        )

    def customattributes_list_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps([{'attributeName': 'string', 'attributeType': 'string'}])
        self.wfile.write(response_content.encode('utf-8'))
        return

    def matches_CUSTOM_ATTRIBUTES_da31003b02f4519eaa18073aa1b85cee(self):
        return re.search(
            self.CUSTOM_ATTRIBUTES_da31003b02f4519eaa18073aa1b85cee_PATTERN,
            self.path
        )

    def customattributes_create_custom_attribute_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_CUSTOM_ATTRIBUTES_019ebd4481045cdb92a3d380f1c0237e(self):
        return re.search(
            self.CUSTOM_ATTRIBUTES_019ebd4481045cdb92a3d380f1c0237e_PATTERN,
            self.path
        )

    def customattributes_rename_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_CUSTOM_ATTRIBUTES_bef8c77f8d035a44a5c250db397dd59a(self):
        return re.search(
            self.CUSTOM_ATTRIBUTES_bef8c77f8d035a44a5c250db397dd59a_PATTERN,
            self.path
        )

    def customattributes_get_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_CUSTOM_ATTRIBUTES_bd6f3a50e58459b1b7f735dce452c9b2(self):
        return re.search(
            self.CUSTOM_ATTRIBUTES_bd6f3a50e58459b1b7f735dce452c9b2_PATTERN,
            self.path
        )

    def customattributes_delete_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_DATACONNECT_SERVICES_d98458307a1c5cea9b11ee96945fcefa(self):
        return re.search(
            self.DATACONNECT_SERVICES_d98458307a1c5cea9b11ee96945fcefa_PATTERN,
            self.path
        )

    def dataconnect_services_get_odbc_detail_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'response': {'hostname': 'string', 'port': 0, 'servicename': 'string', 'username': 'string'}, 'version': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return

    def matches_DATACONNECT_SERVICES_e0455a6b0945530585c7a32f36ae76b0(self):
        return re.search(
            self.DATACONNECT_SERVICES_e0455a6b0945530585c7a32f36ae76b0_PATTERN,
            self.path
        )

    def dataconnect_services_get_dataconnect_service_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'response': {'isEnabled': True, 'isPasswordChanged': True, 'passwordExpiresInDays': 0, 'passwordExpiresOn': 'string'}, 'version': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return

    def matches_DATACONNECT_SERVICES_709687a7458c54ed9f4761c46a3c5e58(self):
        return re.search(
            self.DATACONNECT_SERVICES_709687a7458c54ed9f4761c46a3c5e58_PATTERN,
            self.path
        )

    def dataconnect_services_update_dataconnect_password_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_DATACONNECT_SERVICES_550974fed9705442857aa0fee26a7a62(self):
        return re.search(
            self.DATACONNECT_SERVICES_550974fed9705442857aa0fee26a7a62_PATTERN,
            self.path
        )

    def dataconnect_services_update_dataconnect_password_expiry_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_DATACONNECT_SERVICES_b1b4aa6b58875e0cb90805def240b058(self):
        return re.search(
            self.DATACONNECT_SERVICES_b1b4aa6b58875e0cb90805def240b058_PATTERN,
            self.path
        )

    def dataconnect_services_set_data_connect_service_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def node_deployment_get_deployment_nodes_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'response': [{'hostname': 'string', 'fqdn': 'string', 'ipAddress': 'string', 'roles': ['string'], 'services': ['string'], 'nodeStatus': 'string'}], 'version': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def node_group_get_node_groups_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'response': [{'name': 'string', 'description': 'string', 'marCache': {'replication-timeout': 0, 'replication-attempts': 0, 'query-timeout': 0, 'query-attempts': 0}}], 'version': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def nodeservices_get_interfaces_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def nodeservices_get_sxp_interface_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def nodeservices_set_sxp_interface_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def nodeservices_get_profiler_probe_config_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'response': {'netflow': {'interface': 'string', 'port': 0}, 'dhcp': {'interface': 'string', 'port': 0}, 'dhcpSpan': {'interface': 'string'}, 'http': {'interface': 'string'}, 'radius': [{}], 'nmap': [{}], 'dns': {'timeout': 0}, 'snmpQuery': {'retries': 0, 'timeout': 0, 'eventTimeout': 0}, 'snmpTrap': {'linkTrapQuery': True, 'macTrapQuery': True, 'interface': 'string', 'port': 0}, 'activeDirectory': {'daysBeforeRescan': 0}, 'pxgrid': [{}]}, 'version': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def nodeservices_set_profiler_probe_config_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def pan_ha_get_pan_ha_status_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'response': {'isEnabled': True, 'primaryHealthCheckNode': {'hostname': 'string'}, 'secondaryHealthCheckNode': {'hostname': 'string'}, 'pollingInterval': 0, 'failedAttempts': 0}, 'version': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def matches_AD_GROUPS_d9932860667c5586a9984568d5d8223b(self):
        return re.search(
            self.AD_GROUPS_d9932860667c5586a9984568d5d8223b_PATTERN,
            self.path
        )

    def a_d_groups_get_adgroups_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps([{'name': 'string', 'source': 'string'}])
        self.wfile.write(response_content.encode('utf-8'))
        return

    def matches_ACTIVE_DIRECTORIES_411653fa59ab523b87f9d89c16fc5f7b(self):
        return re.search(
            self.ACTIVE_DIRECTORIES_411653fa59ab523b87f9d89c16fc5f7b_PATTERN,
            self.path
        )

    def active_directories_get_active_directories_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps([{'directoryID': 'string', 'domain': 'string', 'name': 'string'}])
        self.wfile.write(response_content.encode('utf-8'))
        return

    def matches_DUO_IDENTITY_SYNC_1df181ea3dcd56bfbe7f79ff573b5fc2(self):
        return re.search(
            self.DUO_IDENTITY_SYNC_1df181ea3dcd56bfbe7f79ff573b5fc2_PATTERN,
            self.path
        )

    def duo_identity_sync_get_identitysync_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'response': [{'adGroups': 0, 'destination': 'string', 'lastSync': 'string', 'name': 'string', 'source': 'string', 'syncStatus': 'string'}], 'version': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return

    def matches_DUO_IDENTITY_SYNC_69373c868f315159b4ba2bc7682c7887(self):
        return re.search(
            self.DUO_IDENTITY_SYNC_69373c868f315159b4ba2bc7682c7887_PATTERN,
            self.path
        )

    def duo_identity_sync_create_identitysync_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_DUO_IDENTITY_SYNC_1076d1e5dabd543288df5173b39fb8cf(self):
        return re.search(
            self.DUO_IDENTITY_SYNC_1076d1e5dabd543288df5173b39fb8cf_PATTERN,
            self.path
        )

    def duo_identity_sync_update_status_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_DUO_IDENTITY_SYNC_19763764ea97590ebf96ed2ccce5e19c(self):
        return re.search(
            self.DUO_IDENTITY_SYNC_19763764ea97590ebf96ed2ccce5e19c_PATTERN,
            self.path
        )

    def duo_identity_sync_cancel_sync_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_DUO_IDENTITY_SYNC_e23a28af8006509c85271e07d522a12e(self):
        return re.search(
            self.DUO_IDENTITY_SYNC_e23a28af8006509c85271e07d522a12e_PATTERN,
            self.path
        )

    def duo_identity_sync_sync_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_DUO_IDENTITY_SYNC_4eceed7a4795587b812ca7d4fb71c1ad(self):
        return re.search(
            self.DUO_IDENTITY_SYNC_4eceed7a4795587b812ca7d4fb71c1ad_PATTERN,
            self.path
        )

    def duo_identity_sync_get_identitysync_by_sync_name_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'response': {'identitySync': {'adGroups': [{'name': 'string', 'sid': 'string', 'source': 'string'}], 'configurations': {'activeDirectories': [{'directoryID': 'string', 'domain': 'string', 'name': 'string'}]}, 'lastSync': 'string', 'syncName': 'string', 'syncSchedule': {'interval': 0, 'intervalUnit': 'string', 'schedulerSync': 'string', 'startDate': 'string'}, 'syncStatus': 'string'}}, 'version': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return

    def matches_DUO_IDENTITY_SYNC_28cd01786a6f5573be19bbd17a7a2561(self):
        return re.search(
            self.DUO_IDENTITY_SYNC_28cd01786a6f5573be19bbd17a7a2561_PATTERN,
            self.path
        )

    def duo_identity_sync_update_identitysync_by_sync_name_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_DUO_IDENTITY_SYNC_7a957abe42fe5ec4ba32c71309d30c12(self):
        return re.search(
            self.DUO_IDENTITY_SYNC_7a957abe42fe5ec4ba32c71309d30c12_PATTERN,
            self.path
        )

    def duo_identity_sync_delete_identity_sync_by_sync_name_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_ENDPOINT_STOP_REPLICATION_SERVICE_c99b06123cb958fb91d7581457e28ca1(self):
        return re.search(
            self.ENDPOINT_STOP_REPLICATION_SERVICE_c99b06123cb958fb91d7581457e28ca1_PATTERN,
            self.path
        )

    def endpoint_stop_replication_service_get_stop_replication_status_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'response': {'isEnabled': True}, 'version': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return

    def matches_ENDPOINT_STOP_REPLICATION_SERVICE_bdc839ed309b593d8e7b8a90ef5930c5(self):
        return re.search(
            self.ENDPOINT_STOP_REPLICATION_SERVICE_bdc839ed309b593d8e7b8a90ef5930c5_PATTERN,
            self.path
        )

    def endpoint_stop_replication_service_set_stop_replication_service_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_NATIVE_IPSEC_23993d9fe5cd54278a69cb1b5c800c32(self):
        return re.search(
            self.NATIVE_IPSEC_23993d9fe5cd54278a69cb1b5c800c32_PATTERN,
            self.path
        )

    def native_ipsec_get_ipsec_enabled_nodes_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'nextPage': {'href': 'string', 'rel': 'string', 'type': 'string'}, 'previousPage': {'href': 'string', 'rel': 'string', 'type': 'string'}, 'response': [{'authType': 'string', 'certId': 'string', 'configureVti': True, 'createTime': 'string', 'espAhProtocol': 'string', 'hostName': 'string', 'id': 'string', 'iface': 'string', 'ikeReAuthTime': 0, 'ikeVersion': 'string', 'localInternalIp': 'string', 'modeOption': 'string', 'nadIp': 'string', 'phaseOneDHGroup': 'string', 'phaseOneEncryptionAlgo': 'string', 'phaseOneHashAlgo': 'string', 'phaseOneLifeTime': 0, 'phaseTwoDHGroup': 'string', 'phaseTwoEncryptionAlgo': 'string', 'phaseTwoHashAlgo': 'string', 'phaseTwoLifeTime': 0, 'psk': 'string', 'remotePeerInternalIp': 'string', 'status': 'string', 'updateTime': 'string'}], 'version': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return

    def matches_NATIVE_IPSEC_5d4fb0706d0f5226b8691538a2bc7309(self):
        return re.search(
            self.NATIVE_IPSEC_5d4fb0706d0f5226b8691538a2bc7309_PATTERN,
            self.path
        )

    def native_ipsec_update_ipsec_connection_config_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'response': {'authType': 'string', 'certId': 'string', 'configureVti': True, 'createTime': 'string', 'espAhProtocol': 'string', 'hostName': 'string', 'id': 'string', 'iface': 'string', 'ikeReAuthTime': 0, 'ikeVersion': 'string', 'link': {'href': 'string', 'rel': 'string', 'type': 'string'}, 'localInternalIp': 'string', 'modeOption': 'string', 'nadIp': 'string', 'phaseOneDHGroup': 'string', 'phaseOneEncryptionAlgo': 'string', 'phaseOneHashAlgo': 'string', 'phaseOneLifeTime': 0, 'phaseTwoDHGroup': 'string', 'phaseTwoEncryptionAlgo': 'string', 'phaseTwoHashAlgo': 'string', 'phaseTwoLifeTime': 0, 'psk': 'string', 'remotePeerInternalIp': 'string', 'status': 'string', 'updateTime': 'string'}, 'version': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return

    def matches_NATIVE_IPSEC_289ef20d5d63551dbe25878007747598(self):
        return re.search(
            self.NATIVE_IPSEC_289ef20d5d63551dbe25878007747598_PATTERN,
            self.path
        )

    def native_ipsec_create_ipsec_connection_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_NATIVE_IPSEC_eca8a69196d555a1b7e71cf190bd2641(self):
        return re.search(
            self.NATIVE_IPSEC_eca8a69196d555a1b7e71cf190bd2641_PATTERN,
            self.path
        )

    def native_ipsec_bulk_ip_sec_operation_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_NATIVE_IPSEC_3a5e87f906e357bcb972c60ee082d89b(self):
        return re.search(
            self.NATIVE_IPSEC_3a5e87f906e357bcb972c60ee082d89b_PATTERN,
            self.path
        )

    def native_ipsec_get_ip_sec_certificates_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'response': [{'friendlyName': 'string', 'id': 'string'}], 'version': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return

    def matches_NATIVE_IPSEC_4f159a76b6aa52c2b0d0a2fe31dcae91(self):
        return re.search(
            self.NATIVE_IPSEC_4f159a76b6aa52c2b0d0a2fe31dcae91_PATTERN,
            self.path
        )

    def native_ipsec_disable_ipsec_connection_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_NATIVE_IPSEC_2b57a1b126cb53ed8533eb22db13719d(self):
        return re.search(
            self.NATIVE_IPSEC_2b57a1b126cb53ed8533eb22db13719d_PATTERN,
            self.path
        )

    def native_ipsec_enable_ipsec_connection_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_NATIVE_IPSEC_208a5dd6bd055c73bc02c8a389fd353f(self):
        return re.search(
            self.NATIVE_IPSEC_208a5dd6bd055c73bc02c8a389fd353f_PATTERN,
            self.path
        )

    def native_ipsec_get_ipsec_node_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_NATIVE_IPSEC_9f2a9c1f22035982beaa10f027814d01(self):
        return re.search(
            self.NATIVE_IPSEC_9f2a9c1f22035982beaa10f027814d01_PATTERN,
            self.path
        )

    def native_ipsec_remove_ipsec_connection_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def licensing_get_registration_info_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'response': {'tier': ['string'], 'connectionType': 'string', 'registrationState': 'string', 'ssmOnPremServer': 'string'}, 'version': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def licensing_get_tier_state_info_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps([{'name': 'string', 'status': 'string', 'compliance': 'string', 'consumptionCounter': 0, 'daysOutOfCompliance': 'string', 'lastAuthorization': 'string'}])
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def licensing_get_feature_to_tier_mapping_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps([{'tier': 'string', 'featureName': ['string']}])
        self.wfile.write(response_content.encode('utf-8'))
        return

    def matches_CONFIGURATION_c745aa263c5058f0a4e9f6b506954df9(self):
        return re.search(
            self.CONFIGURATION_c745aa263c5058f0a4e9f6b506954df9_PATTERN,
            self.path
        )

    def configuration_get_configuration_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'enableEPO': True, 'enableRCM': True})
        self.wfile.write(response_content.encode('utf-8'))
        return

    def matches_CONFIGURATION_9292140052ab58f0809a3eb6e7561714(self):
        return re.search(
            self.CONFIGURATION_9292140052ab58f0809a3eb6e7561714_PATTERN,
            self.path
        )

    def configuration_update_configuration_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_DUO_MFA_f1841c8263105468a0e51fc4751ba6dc(self):
        return re.search(
            self.DUO_MFA_f1841c8263105468a0e51fc4751ba6dc_PATTERN,
            self.path
        )

    def duo_mfa_get_mfa_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'response': [{'apiHostName': 'string', 'identitySync': 'string', 'name': 'string', 'provider': 'string', 'type': 'string'}], 'version': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return

    def matches_DUO_MFA_45dcf17da7955cee9028a267873d055f(self):
        return re.search(
            self.DUO_MFA_45dcf17da7955cee9028a267873d055f_PATTERN,
            self.path
        )

    def duo_mfa_create_mfa_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_DUO_MFA_4fb47bc0b25f53b093b356d41f1c59ab(self):
        return re.search(
            self.DUO_MFA_4fb47bc0b25f53b093b356d41f1c59ab_PATTERN,
            self.path
        )

    def duo_mfa_test_connection_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_DUO_MFA_72fe75e2be3e56c9836c9c0db3a4be20(self):
        return re.search(
            self.DUO_MFA_72fe75e2be3e56c9836c9c0db3a4be20_PATTERN,
            self.path
        )

    def duo_mfa_get_mfa_byconnection_name_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'response': {'mfa': {'accountConfigurations': {'adminApi': {'ikey': 'string', 'sKey': 'string'}, 'apiHostName': 'string', 'authenticationApi': {'ikey': 'string', 'sKey': 'string'}}, 'connectionName': 'string', 'description': 'string', 'identitySync': 'string', 'type': 'string'}}, 'version': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return

    def matches_DUO_MFA_803320e8eb885d7cb70656383f03864f(self):
        return re.search(
            self.DUO_MFA_803320e8eb885d7cb70656383f03864f_PATTERN,
            self.path
        )

    def duo_mfa_update_m_fa_by_connection_name_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_DUO_MFA_bec78a0adabd51a7bb03a74616b7b501(self):
        return re.search(
            self.DUO_MFA_bec78a0adabd51a7bb03a74616b7b501_PATTERN,
            self.path
        )

    def duo_mfa_delete_mfa_by_connection_name_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_ENABLE_MFA_c4928172faa15fe796dfb42c01705007(self):
        return re.search(
            self.ENABLE_MFA_c4928172faa15fe796dfb42c01705007_PATTERN,
            self.path
        )

    def enable_mfa_enable_mfa_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_IS_MFA_ENABLED_fbd6ee3b38595e79b3a6b06bf7a3439a(self):
        return re.search(
            self.IS_MFA_ENABLED_fbd6ee3b38595e79b3a6b06bf7a3439a_PATTERN,
            self.path
        )

    def is_mfa_enabled_is_mfa_enabled_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'status': True})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def device_administration_network_conditions_get_device_admin_network_conditions_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'response': [{'conditionType': 'string', 'description': 'string', 'id': 'string', 'link': {'href': 'string', 'rel': 'string', 'type': 'string'}, 'name': 'string', 'deviceList': ['string'], 'cliDnisList': ['string'], 'ipAddrList': ['string'], 'macAddrList': ['string'], 'deviceGroupList': ['string']}], 'version': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def matches_PX_GRID_DIRECT_318d1004b4485c06871c0c86358068cb(self):
        return re.search(
            self.PX_GRID_DIRECT_318d1004b4485c06871c0c86358068cb_PATTERN,
            self.path
        )

    def px_grid_direct_get_connector_config_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'response': [{'connector': {'additionalProperties': {}, 'attributes': {'attributeMapping': [{'dictionaryAttribute': 'string', 'includeInDictionary': True, 'jsonAttribute': 'string'}], 'correlationIdentifier': 'string', 'topLevelObject': 'string', 'uniqueIdentifier': 'string', 'versionIdentifier': 'string'}, 'connectorName': 'string', 'connectorType': 'string', 'deltasyncSchedule': {'interval': 0, 'intervalUnit': 'string', 'startDate': 'string'}, 'description': 'string', 'enabled': True, 'fullsyncSchedule': {'interval': 0, 'intervalUnit': 'string', 'startDate': 'string'}, 'protocol': 'string', 'skipCertificateValidations': True, 'url': {'authenticationType': 'string', 'bulkUrl': 'string', 'incrementalUrl': 'string', 'password': 'string', 'userName': 'string'}}}], 'version': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return

    def matches_PX_GRID_DIRECT_af9c8ad00e925e6885c3b3167dbdb4a3(self):
        return re.search(
            self.PX_GRID_DIRECT_af9c8ad00e925e6885c3b3167dbdb4a3_PATTERN,
            self.path
        )

    def px_grid_direct_create_connector_config_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_PX_GRID_DIRECT_9994d4fedcc553a3966efb225bd927c6(self):
        return re.search(
            self.PX_GRID_DIRECT_9994d4fedcc553a3966efb225bd927c6_PATTERN,
            self.path
        )

    def px_grid_direct_get_connector_config_by_connector_name_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_PX_GRID_DIRECT_87dbcbf6ee965b90a47c157c87efef5f(self):
        return re.search(
            self.PX_GRID_DIRECT_87dbcbf6ee965b90a47c157c87efef5f_PATTERN,
            self.path
        )

    def px_grid_direct_update_connector_config_by_connector_name_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_PX_GRID_DIRECT_87dbb36cd7f25770b884da5053decff4(self):
        return re.search(
            self.PX_GRID_DIRECT_87dbb36cd7f25770b884da5053decff4_PATTERN,
            self.path
        )

    def px_grid_direct_delete_connector_config_by_connector_name_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_PX_GRID_DIRECT_851a85e09e275340b9c39f9f0cc77902(self):
        return re.search(
            self.PX_GRID_DIRECT_851a85e09e275340b9c39f9f0cc77902_PATTERN,
            self.path
        )

    def px_grid_direct_getpxgrid_direct_dictionary_references_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_PX_GRID_DIRECT_059f5ea29c9654f99a341aff1c064f9b(self):
        return re.search(
            self.PX_GRID_DIRECT_059f5ea29c9654f99a341aff1c064f9b_PATTERN,
            self.path
        )

    def px_grid_direct_get_connector_config_sync_now_status_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'response': {'connector': {'connectorName': 'string', 'syncStatus': 'string'}}, 'version': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return

    def matches_PX_GRID_DIRECT_a83fbc2fed26547b964c13e5771038f7(self):
        return re.search(
            self.PX_GRID_DIRECT_a83fbc2fed26547b964c13e5771038f7_PATTERN,
            self.path
        )

    def px_grid_direct_sync_now_connector_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_PX_GRID_DIRECT_d4ff0e7ffab4526fbdb811b264bba36d(self):
        return re.search(
            self.PX_GRID_DIRECT_d4ff0e7ffab4526fbdb811b264bba36d_PATTERN,
            self.path
        )

    def px_grid_direct_test_connector_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'connectorName': 'string', 'data': 'string', 'error': 'string', 'skipCertificateValidations': True, 'status': 'string', 'uniqueID': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def repository_get_repositories_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'response': [{'name': 'string', 'protocol': 'string'}], 'version': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def nbarapp_get_nbar_apps_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def nbarapp_create_nbar_app_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def nbarapp_get_nbar_app_by_id_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def nbarapp_update_nbar_app_by_id_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def nbarapp_delete_nbar_app_by_id_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def sgvnmapping_get_sg_vn_mapping_list_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def sgvnmapping_create_sg_vn_mapping_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def sgvnmapping_bulk_create_sg_vn_mappings_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def sgvnmapping_bulk_delete_sg_vn_mappings_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def sgvnmapping_bulk_update_sg_vn_mappings_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def sgvnmapping_get_sg_vn_mapping_by_id_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def sgvnmapping_update_sg_vn_mapping_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'id': 'string', 'lastUpdate': 'string', 'sgName': 'string', 'sgtId': 'string', 'vnId': 'string', 'vnName': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def sgvnmapping_delete_sg_vn_mapping_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def virtualnetwork_get_virtual_networks_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def virtualnetwork_create_virtual_network_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def virtualnetwork_bulk_create_virtual_networks_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def virtualnetwork_bulk_delete_virtual_networks_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def virtualnetwork_bulk_update_virtual_networks_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def virtualnetwork_get_virtual_network_by_id_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def virtualnetwork_update_virtual_network_by_id_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def virtualnetwork_delete_virtual_network_by_id_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def vnvlanmapping_get_vn_vlan_mapping_list_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def vnvlanmapping_create_vn_vlan_mapping_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def vnvlanmapping_bulk_create_vn_vlan_mappings_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def vnvlanmapping_bulk_delete_vn_vlan_mappings_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def vnvlanmapping_bulk_update_vn_vlan_mappings_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def vnvlanmapping_get_vn_vlan_mapping_by_id_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def vnvlanmapping_update_vn_vlan_mapping_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def vnvlanmapping_delete_vn_vlan_mapping_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_FULL_UPGRADE_6a8cb91a4f09598bbdfa6c4b146c2763(self):
        return re.search(
            self.FULL_UPGRADE_6a8cb91a4f09598bbdfa6c4b146c2763_PATTERN,
            self.path
        )

    def fullupgrade_get_precheck_status_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'isValid': True, 'nodecount': 0, 'preCheckReportID': 'string', 'preChecks': [{'checkType': 'string', 'displayname': 'string', 'executionTime': 0, 'message': 'string', 'name': 'string', 'nodes': [{'msg': 'string', 'name': 'string', 'status': 'string'}], 'onFailure': 'string', 'percentage': 0, 'remediationMsg': 'string', 'status': 'string', 'successMsg': 'string', 'successNodes': 0, 'updateTime': 0}], 'status': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return

    def matches_FULL_UPGRADE_aa612059ca395d97922d045b42c75fcc(self):
        return re.search(
            self.FULL_UPGRADE_aa612059ca395d97922d045b42c75fcc_PATTERN,
            self.path
        )

    def fullupgrade_run_pre_checks_in_p_p_a_n_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'response': {'message': 'string', 'preCheckReportID': 'string'}, 'version': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return

    def matches_FULL_UPGRADE_15572010b4b951fa8ed4a6e4da1a5696(self):
        return re.search(
            self.FULL_UPGRADE_15572010b4b951fa8ed4a6e4da1a5696_PATTERN,
            self.path
        )

    def fullupgrade_proceed_status_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'nodes': [{'dbStatus': 'string', 'message': 'string', 'node': 'string', 'percentage': 0, 'progressMsg': 'string', 'status': 'string', 'upgradeTime': 0}], 'percentage': 0, 'remainingUpgradeTime': 0, 'status': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return

    def matches_FULL_UPGRADE_22d4d90ae0435f3fa638b6b4f206b5a6(self):
        return re.search(
            self.FULL_UPGRADE_22d4d90ae0435f3fa638b6b4f206b5a6_PATTERN,
            self.path
        )

    def fullupgrade_initiate_upgrade_on_p_p_a_n_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_FULL_UPGRADE_1255607ea018583db18166b743662136(self):
        return re.search(
            self.FULL_UPGRADE_1255607ea018583db18166b743662136_PATTERN,
            self.path
        )

    def fullupgrade_cancel_staging_on_p_p_a_n_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_FULL_UPGRADE_de4f26345bf95460b81cfce5395e989c(self):
        return re.search(
            self.FULL_UPGRADE_de4f26345bf95460b81cfce5395e989c_PATTERN,
            self.path
        )

    def fullupgrade_stage_status_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'response': [{'dbStatus': 'string', 'message': 'string', 'node': 'string', 'percentage': 0, 'progressMsg': 'string', 'status': 'string'}]})
        self.wfile.write(response_content.encode('utf-8'))
        return

    def matches_FULL_UPGRADE_0d78612f495d584a8a941677e9194f35(self):
        return re.search(
            self.FULL_UPGRADE_0d78612f495d584a8a941677e9194f35_PATTERN,
            self.path
        )

    def fullupgrade_initiate_staging_on_p_p_a_n_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_FULL_UPGRADE_2c8ccef8538b5c3892d8e9211faa051f(self):
        return re.search(
            self.FULL_UPGRADE_2c8ccef8538b5c3892d8e9211faa051f_PATTERN,
            self.path
        )

    def fullupgrade_upgradesummary_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_ENDPOINTS_33977733578154648184bcb37d211030(self):
        return re.search(
            self.ENDPOINTS_33977733578154648184bcb37d211030_PATTERN,
            self.path
        )

    def endpoints_list_1_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps([{'connectedLinks': {}, 'customAttributes': {}, 'description': 'string', 'deviceType': 'string', 'groupId': 'string', 'hardwareRevision': 'string', 'id': 'string', 'identityStore': 'string', 'identityStoreId': 'string', 'ipAddress': 'string', 'mac': 'string', 'mdmAttributes': {}, 'name': 'string', 'portalUser': 'string', 'productId': 'string', 'profileId': 'string', 'protocol': 'string', 'serialNumber': 'string', 'softwareRevision': 'string', 'staticGroupAssignment': True, 'staticProfileAssignment': True, 'vendor': 'string'}])
        self.wfile.write(response_content.encode('utf-8'))
        return

    def matches_ENDPOINTS_5175a51ed0d2536b9df3968e4773abe6(self):
        return re.search(
            self.ENDPOINTS_5175a51ed0d2536b9df3968e4773abe6_PATTERN,
            self.path
        )

    def endpoints_create_end_point_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_ENDPOINTS_e076428d49535723a07a5bbcbcbd128d(self):
        return re.search(
            self.ENDPOINTS_e076428d49535723a07a5bbcbcbd128d_PATTERN,
            self.path
        )

    def endpoints_update_bulk_end_points_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_ENDPOINTS_64dcda215550553980db1cd60c7314a7(self):
        return re.search(
            self.ENDPOINTS_64dcda215550553980db1cd60c7314a7_PATTERN,
            self.path
        )

    def endpoints_create_bulk_end_points_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_ENDPOINTS_0d43c525d23b5c4bba03a0c774d4d411(self):
        return re.search(
            self.ENDPOINTS_0d43c525d23b5c4bba03a0c774d4d411_PATTERN,
            self.path
        )

    def endpoints_delete_bulk_end_points_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_ENDPOINTS_689e06db5cda5ba7b82f14cbd46d262c(self):
        return re.search(
            self.ENDPOINTS_689e06db5cda5ba7b82f14cbd46d262c_PATTERN,
            self.path
        )

    def endpoints_get_device_type_summary_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps([{'deviceType': 'string', 'total': 'string'}])
        self.wfile.write(response_content.encode('utf-8'))
        return

    def matches_ENDPOINTS_f190d005d391514e97e04abe777a25f6(self):
        return re.search(
            self.ENDPOINTS_f190d005d391514e97e04abe777a25f6_PATTERN,
            self.path
        )

    def endpoints_get_1_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_ENDPOINTS_ced9c2b976d053d898d9867def5eef28(self):
        return re.search(
            self.ENDPOINTS_ced9c2b976d053d898d9867def5eef28_PATTERN,
            self.path
        )

    def endpoints_update_endpoint_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_ENDPOINTS_71de74c081ab537aadfcb4843f33e4c7(self):
        return re.search(
            self.ENDPOINTS_71de74c081ab537aadfcb4843f33e4c7_PATTERN,
            self.path
        )

    def endpoints_delete_endpoint_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_ENDPOINTS_35a7b96eb91052e49e6fc7bfc499ba5f(self):
        return re.search(
            self.ENDPOINTS_35a7b96eb91052e49e6fc7bfc499ba5f_PATTERN,
            self.path
        )

    def endpoints_create_end_point_task_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def network_device_group_get_network_device_group_by_name_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'NetworkDeviceGroup': {'id': 'string', 'name': 'string', 'description': 'string', 'link': {'rel': 'string', 'href': 'string', 'type': 'string'}, 'ndgtype': 'string'}})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def do_GET(self):
        ...
        if self.matches_SGT_RANGE_RESERVATION_ab239b1cb373585dab8b3d2a1755096a():
            self.sgt_range_reservation_get_sgt_reserved_ranges_response()
            return

        if self.matches_SGT_RANGE_RESERVATION_8955cf7b3b15569893114af795c1e8e2():
            self.sgt_range_reservation_get_sgt_reserved_range_response()
            return

        if self.matches_SUBSCRIBER_bb725fc737535a23b2459a255a4b9725():
            self.subscriber_get_all_subscribers_response()
            return

        if self.matches_SUBSCRIBER_2bf1dfb9226e534cb039880148e47e95():
            self.subscriber_get_subscriber_by_id_response()
            return

        if self.matches_SUBSCRIBER_a1b71359fd0351f3a7f824ce8c4df14a():
            self.subscriber_get_subscriber_by_i_m_s_i_response()
            return

        if self.matches_USER_EQUIPMENT_b5d936170e535fb5a2e6742807081bb5():
            self.user_equipment_get_user_equipments_response()
            return

        if self.matches_USER_EQUIPMENT_b15aa7a86eb25690b0306e29e0acdc9d():
            self.user_equipment_get_user_equipment_by_id_response()
            return

        if self.matches_USER_EQUIPMENT_d990d821a0885cc2a002144e1fa1a7eb():
            self.user_equipment_get_user_equipments_by_subscriber_id_response()
            return

        if self.matches_USER_EQUIPMENT_b97cb90bda30562198f19eb20a343d2a():
            self.user_equipment_get_user_equipment_by_i_m_e_i_response()
            return
        ...
        if self.matches_CUSTOM_ATTRIBUTES_70a02a1af2b156c8b040d628e59f86e9():
            self.customattributes_list_response()
            return

        if self.matches_CUSTOM_ATTRIBUTES_bef8c77f8d035a44a5c250db397dd59a():
            self.customattributes_get_response()
            return

        if self.matches_DATACONNECT_SERVICES_d98458307a1c5cea9b11ee96945fcefa():
            self.dataconnect_services_get_odbc_detail_response()
            return

        if self.matches_DATACONNECT_SERVICES_e0455a6b0945530585c7a32f36ae76b0():
            self.dataconnect_services_get_dataconnect_service_response()
            return
        ...
        if self.matches_NODE_SERVICES_f6f429e124ea58ba85f0b34296d61300():
            self.nodeservices_get_interfaces_response()
            return

        if self.matches_NODE_SERVICES_86620252ba4b550caf3845b4cbe1074d():
            self.nodeservices_get_sxp_interface_response()
            return

        if self.matches_NODE_SERVICES_94bfa308ed7b5fb6acde734f6267b4e3():
            self.nodeservices_get_profiler_probe_config_response()
            return
        ...
        if self.matches_AD_GROUPS_d9932860667c5586a9984568d5d8223b():
            self.a_d_groups_get_adgroups_response()
            return

        if self.matches_ACTIVE_DIRECTORIES_411653fa59ab523b87f9d89c16fc5f7b():
            self.active_directories_get_active_directories_response()
            return

        if self.matches_DUO_IDENTITY_SYNC_1df181ea3dcd56bfbe7f79ff573b5fc2():
            self.duo_identity_sync_get_identitysync_response()
            return

        if self.matches_DUO_IDENTITY_SYNC_19763764ea97590ebf96ed2ccce5e19c():
            self.duo_identity_sync_cancel_sync_response()
            return

        if self.matches_DUO_IDENTITY_SYNC_e23a28af8006509c85271e07d522a12e():
            self.duo_identity_sync_sync_response()
            return

        if self.matches_DUO_IDENTITY_SYNC_4eceed7a4795587b812ca7d4fb71c1ad():
            self.duo_identity_sync_get_identitysync_by_sync_name_response()
            return

        if self.matches_ENDPOINT_STOP_REPLICATION_SERVICE_c99b06123cb958fb91d7581457e28ca1():
            self.endpoint_stop_replication_service_get_stop_replication_status_response()
            return

        if self.matches_NATIVE_IPSEC_23993d9fe5cd54278a69cb1b5c800c32():
            self.native_ipsec_get_ipsec_enabled_nodes_response()
            return

        if self.matches_NATIVE_IPSEC_3a5e87f906e357bcb972c60ee082d89b():
            self.native_ipsec_get_ip_sec_certificates_response()
            return

        if self.matches_NATIVE_IPSEC_208a5dd6bd055c73bc02c8a389fd353f():
            self.native_ipsec_get_ipsec_node_response()
            return
        ...
        if self.matches_CONFIGURATION_c745aa263c5058f0a4e9f6b506954df9():
            self.configuration_get_configuration_response()
            return

        if self.matches_DUO_MFA_f1841c8263105468a0e51fc4751ba6dc():
            self.duo_mfa_get_mfa_response()
            return

        if self.matches_DUO_MFA_72fe75e2be3e56c9836c9c0db3a4be20():
            self.duo_mfa_get_mfa_byconnection_name_response()
            return

        if self.matches_IS_MFA_ENABLED_fbd6ee3b38595e79b3a6b06bf7a3439a():
            self.is_mfa_enabled_is_mfa_enabled_response()
            return
        ...
        if self.matches_PX_GRID_DIRECT_318d1004b4485c06871c0c86358068cb():
            self.px_grid_direct_get_connector_config_response()
            return

        if self.matches_PX_GRID_DIRECT_9994d4fedcc553a3966efb225bd927c6():
            self.px_grid_direct_get_connector_config_by_connector_name_response()
            return

        if self.matches_PX_GRID_DIRECT_851a85e09e275340b9c39f9f0cc77902():
            self.px_grid_direct_getpxgrid_direct_dictionary_references_response()
            return

        if self.matches_PX_GRID_DIRECT_059f5ea29c9654f99a341aff1c064f9b():
            self.px_grid_direct_get_connector_config_sync_now_status_response()
            return
        ...
        if self.matches_FULL_UPGRADE_6a8cb91a4f09598bbdfa6c4b146c2763():
            self.fullupgrade_get_precheck_status_response()
            return

        if self.matches_FULL_UPGRADE_15572010b4b951fa8ed4a6e4da1a5696():
            self.fullupgrade_proceed_status_response()
            return

        if self.matches_FULL_UPGRADE_de4f26345bf95460b81cfce5395e989c():
            self.fullupgrade_stage_status_response()
            return

        if self.matches_FULL_UPGRADE_2c8ccef8538b5c3892d8e9211faa051f():
            self.fullupgrade_upgradesummary_response()
            return
        ...
        if self.matches_ENDPOINTS_33977733578154648184bcb37d211030():
            self.endpoints_list_1_response()
            return

        if self.matches_ENDPOINTS_689e06db5cda5ba7b82f14cbd46d262c():
            self.endpoints_get_device_type_summary_response()
            return

        if self.matches_ENDPOINTS_f190d005d391514e97e04abe777a25f6():
            self.endpoints_get_1_response()
            return
    ...
    def do_POST(self):
        ...
        if self.matches_SGT_RANGE_RESERVATION_3c565815d18a5b2bbc5f64f935d322f1():
            self.sgt_range_reservation_reserve_sgt_range_response()
            return

        if self.matches_SUBSCRIBER_3083c9ea8f91504d9aa46ebd90dd1ab4():
            self.subscriber_create_subscriber_response()
            return

        if self.matches_SUBSCRIBER_ee509b9ea4465d33bcb6552b30ec32b6():
            self.subscriber_bulk_subscriber_operation_response()
            return

        if self.matches_USER_EQUIPMENT_6a2770b9fac658769ca2c63ca6984b9e():
            self.user_equipment_create_user_equipment_response()
            return

        if self.matches_USER_EQUIPMENT_06bc5a2ced485ac2a06f77d7cc36ee20():
            self.user_equipment_create_user_equipments_from_c_s_v_response()
            return

        if self.matches_USER_EQUIPMENT_79a3bd66e4d75f5f99198a5999e596a8():
            self.user_equipment_bulk_user_equipment_operation_response()
            return
        ...
        if self.matches_CUSTOM_ATTRIBUTES_da31003b02f4519eaa18073aa1b85cee():
            self.customattributes_create_custom_attribute_response()
            return

        if self.matches_CUSTOM_ATTRIBUTES_019ebd4481045cdb92a3d380f1c0237e():
            self.customattributes_rename_response()
            return
        ...
        if self.matches_DUO_IDENTITY_SYNC_69373c868f315159b4ba2bc7682c7887():
            self.duo_identity_sync_create_identitysync_response()
            return

        if self.matches_NATIVE_IPSEC_289ef20d5d63551dbe25878007747598():
            self.native_ipsec_create_ipsec_connection_response()
            return

        if self.matches_NATIVE_IPSEC_eca8a69196d555a1b7e71cf190bd2641():
            self.native_ipsec_bulk_ip_sec_operation_response()
            return
        ...
        if self.matches_DUO_MFA_45dcf17da7955cee9028a267873d055f():
            self.duo_mfa_create_mfa_response()
            return

        if self.matches_DUO_MFA_4fb47bc0b25f53b093b356d41f1c59ab():
            self.duo_mfa_test_connection_response()
            return
        ...
        if self.matches_PX_GRID_DIRECT_af9c8ad00e925e6885c3b3167dbdb4a3():
            self.px_grid_direct_create_connector_config_response()
            return

        if self.matches_PX_GRID_DIRECT_a83fbc2fed26547b964c13e5771038f7():
            self.px_grid_direct_sync_now_connector_response()
            return

        if self.matches_PX_GRID_DIRECT_d4ff0e7ffab4526fbdb811b264bba36d():
            self.px_grid_direct_test_connector_response()
            return
        ...
        if self.matches_NBAR_APP_ccc30178afce5e51a65e96cd95ca1773():
            self.nbarapp_create_nbar_app_response()
            return

        if self.matches_SG_VN_MAPPING_018b050fff6a5302ace3e16674c8b19a():
            self.sgvnmapping_create_sg_vn_mapping_response()
            return

        if self.matches_SG_VN_MAPPING_3e81b5f00f35577dbad11186f70f25be():
            self.sgvnmapping_bulk_create_sg_vn_mappings_response()
            return

        if self.matches_SG_VN_MAPPING_3c5cad090a875d9d8bd87e59654c9d75():
            self.sgvnmapping_bulk_delete_sg_vn_mappings_response()
            return

        if self.matches_SG_VN_MAPPING_80c9c798a8ce58b88b3231575f5b8c98():
            self.sgvnmapping_bulk_update_sg_vn_mappings_response()
            return

        if self.matches_VIRTUAL_NETWORK_fe478ea1775758638d714efe1b67eec2():
            self.virtualnetwork_create_virtual_network_response()
            return

        if self.matches_VIRTUAL_NETWORK_f7253733d7025c8b8459478b159e84fc():
            self.virtualnetwork_bulk_create_virtual_networks_response()
            return

        if self.matches_VIRTUAL_NETWORK_b6cdd5dd57b95d8bac87ce9600a84b5d():
            self.virtualnetwork_bulk_delete_virtual_networks_response()
            return

        if self.matches_VIRTUAL_NETWORK_e3c62bba9f9e5344a38479f6437cf8b4():
            self.virtualnetwork_bulk_update_virtual_networks_response()
            return

        if self.matches_VN_VLAN_MAPPING_6b06fcd396bc5494be66e198df78e1b2():
            self.vnvlanmapping_create_vn_vlan_mapping_response()
            return

        if self.matches_VN_VLAN_MAPPING_539fd28158d85d37ab1a1d616c56448c():
            self.vnvlanmapping_bulk_create_vn_vlan_mappings_response()
            return

        if self.matches_VN_VLAN_MAPPING_67dcb60f20b95a999fa1f4918ad1a9e3():
            self.vnvlanmapping_bulk_delete_vn_vlan_mappings_response()
            return

        if self.matches_VN_VLAN_MAPPING_bc2c834bbed356fcafd18fd78d900c0b():
            self.vnvlanmapping_bulk_update_vn_vlan_mappings_response()
            return

        if self.matches_FULL_UPGRADE_aa612059ca395d97922d045b42c75fcc():
            self.fullupgrade_run_pre_checks_in_p_p_a_n_response()
            return

        if self.matches_FULL_UPGRADE_22d4d90ae0435f3fa638b6b4f206b5a6():
            self.fullupgrade_initiate_upgrade_on_p_p_a_n_response()
            return

        if self.matches_FULL_UPGRADE_1255607ea018583db18166b743662136():
            self.fullupgrade_cancel_staging_on_p_p_a_n_response()
            return

        if self.matches_FULL_UPGRADE_0d78612f495d584a8a941677e9194f35():
            self.fullupgrade_initiate_staging_on_p_p_a_n_response()
            return
        ...
        if self.matches_ENDPOINTS_5175a51ed0d2536b9df3968e4773abe6():
            self.endpoints_create_end_point_response()
            return

        if self.matches_ENDPOINTS_64dcda215550553980db1cd60c7314a7():
            self.endpoints_create_bulk_end_points_response()
            return

        if self.matches_ENDPOINTS_35a7b96eb91052e49e6fc7bfc499ba5f():
            self.endpoints_create_end_point_task_response()
            return
    ...
    def do_PUT(self):
        ...
        if self.matches_SGT_RANGE_RESERVATION_90c8c7bb726f53e7be3a2023aa3dda80():
            self.sgt_range_reservation_update_reserved_range_response()
            return

        if self.matches_SUBSCRIBER_cfc8b401a45650b386d0ae88c2ac3ef4():
            self.subscriber_update_subscriber_response()
            return

        if self.matches_USER_EQUIPMENT_cf803097098c5553a2f1e5ae0c526da5():
            self.user_equipment_update_user_equipment_response()
            return
        ...
        if self.matches_DATACONNECT_SERVICES_709687a7458c54ed9f4761c46a3c5e58():
            self.dataconnect_services_update_dataconnect_password_response()
            return

        if self.matches_DATACONNECT_SERVICES_550974fed9705442857aa0fee26a7a62():
            self.dataconnect_services_update_dataconnect_password_expiry_response()
            return

        if self.matches_DATACONNECT_SERVICES_b1b4aa6b58875e0cb90805def240b058():
            self.dataconnect_services_set_data_connect_service_response()
            return
        ...
        if self.matches_NODE_SERVICES_6c6d188a13915253869849c4b0be7759():
            self.nodeservices_set_sxp_interface_response()
            return

        if self.matches_NODE_SERVICES_bba25b96ab6c5a99a7e7933a1ef71977():
            self.nodeservices_set_profiler_probe_config_response()
            return
        ...
        if self.matches_DUO_IDENTITY_SYNC_1076d1e5dabd543288df5173b39fb8cf():
            self.duo_identity_sync_update_status_response()
            return

        if self.matches_DUO_IDENTITY_SYNC_28cd01786a6f5573be19bbd17a7a2561():
            self.duo_identity_sync_update_identitysync_by_sync_name_response()
            return

        if self.matches_ENDPOINT_STOP_REPLICATION_SERVICE_bdc839ed309b593d8e7b8a90ef5930c5():
            self.endpoint_stop_replication_service_set_stop_replication_service_response()
            return

        if self.matches_NATIVE_IPSEC_5d4fb0706d0f5226b8691538a2bc7309():
            self.native_ipsec_update_ipsec_connection_config_response()
            return

        if self.matches_NATIVE_IPSEC_4f159a76b6aa52c2b0d0a2fe31dcae91():
            self.native_ipsec_disable_ipsec_connection_response()
            return

        if self.matches_NATIVE_IPSEC_2b57a1b126cb53ed8533eb22db13719d():
            self.native_ipsec_enable_ipsec_connection_response()
            return

        if self.matches_CONFIGURATION_9292140052ab58f0809a3eb6e7561714():
            self.configuration_update_configuration_response()
            return

        if self.matches_DUO_MFA_803320e8eb885d7cb70656383f03864f():
            self.duo_mfa_update_m_fa_by_connection_name_response()
            return

        if self.matches_ENABLE_MFA_c4928172faa15fe796dfb42c01705007():
            self.enable_mfa_enable_mfa_response()
            return
        ...
        if self.matches_PX_GRID_DIRECT_87dbcbf6ee965b90a47c157c87efef5f():
            self.px_grid_direct_update_connector_config_by_connector_name_response()
            return
        ...
        if self.matches_NBAR_APP_b55622f1671359919573b261ba16ea71():
            self.nbarapp_update_nbar_app_by_id_response()
            return

        if self.matches_SG_VN_MAPPING_147075a66f9651fca28e85b97cf1b968():
            self.sgvnmapping_update_sg_vn_mapping_response()
            return

        if self.matches_VIRTUAL_NETWORK_6d02f9a7ed46581b8baf07e182f80695():
            self.virtualnetwork_update_virtual_network_by_id_response()
            return

        if self.matches_VN_VLAN_MAPPING_c3d67df26a4d58f5a5efc6083ba187eb():
            self.vnvlanmapping_update_vn_vlan_mapping_response()
            return

        if self.matches_ENDPOINTS_e076428d49535723a07a5bbcbcbd128d():
            self.endpoints_update_bulk_end_points_response()
            return

        if self.matches_ENDPOINTS_ced9c2b976d053d898d9867def5eef28():
            self.endpoints_update_endpoint_response()
            return
    ...
    def do_DELETE(self):
        ...
        if self.matches_SGT_RANGE_RESERVATION_086ca7d6274e5090be92eccb6facea16():
            self.sgt_range_reservation_delete_sgt_reserve_range_response()
            return

        if self.matches_SUBSCRIBER_ce70db8b014a599d8b6d623c4713b176():
            self.subscriber_delete_subscriber_response()
            return

        if self.matches_USER_EQUIPMENT_ebecb7076ea45c289951b77ba6de7508():
            self.user_equipment_delete_user_equipment_response()
            return
        ...
        if self.matches_CUSTOM_ATTRIBUTES_bd6f3a50e58459b1b7f735dce452c9b2():
            self.customattributes_delete_response()
            return
        ...
        if self.matches_DUO_IDENTITY_SYNC_7a957abe42fe5ec4ba32c71309d30c12():
            self.duo_identity_sync_delete_identity_sync_by_sync_name_response()
            return

        if self.matches_NATIVE_IPSEC_9f2a9c1f22035982beaa10f027814d01():
            self.native_ipsec_remove_ipsec_connection_response()
            return

        if self.matches_DUO_MFA_bec78a0adabd51a7bb03a74616b7b501():
            self.duo_mfa_delete_mfa_by_connection_name_response()
            return
        ...
        if self.matches_PX_GRID_DIRECT_87dbb36cd7f25770b884da5053decff4():
            self.px_grid_direct_delete_connector_config_by_connector_name_response()
            return
        ...
        if self.matches_NBAR_APP_44d289d5685350f5b00f130db0a45142():
            self.nbarapp_delete_nbar_app_by_id_response()
            return

        if self.matches_SG_VN_MAPPING_0718cb6b83a55dfb8f3536b43cfaf081():
            self.sgvnmapping_delete_sg_vn_mapping_response()
            return

        if self.matches_VIRTUAL_NETWORK_30f7fda88868581085da6ac8c0e04b5c():
            self.virtualnetwork_delete_virtual_network_by_id_response()
            return

        if self.matches_VN_VLAN_MAPPING_97fae20bb0ed56cd9a07518b06fdf67f():
            self.vnvlanmapping_delete_vn_vlan_mapping_response()
            return

        if self.matches_ENDPOINTS_0d43c525d23b5c4bba03a0c774d4d411():
            self.endpoints_delete_bulk_end_points_response()
            return

        if self.matches_ENDPOINTS_71de74c081ab537aadfcb4843f33e4c7():
            self.endpoints_delete_endpoint_response()
            return

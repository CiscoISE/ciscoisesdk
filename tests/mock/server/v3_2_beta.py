...
class MockServerRequestHandler_v3_2_beta(BaseHTTPRequestHandler):
    ...
    EDDA_3c8f79c0801555878ad94493ade34587_PATTERN = re.compile(r"/api/v1/edda/connector-config")
    EDDA_92c89285c31159faa2fb8abee25ce4a4_PATTERN = re.compile(r"/api/v1/edda/connector-config")
    EDDA_a3c21e5b61d95a0b9acf313e3ea03ad7_PATTERN = re.compile(r"/api/v1/edda/connector-config/string")
    EDDA_7f5b69ccd0075b18a3de9e72b9e450cb_PATTERN = re.compile(r"/api/v1/edda/connector-config/string")
    EDDA_7011b1f3a77153ee82dca51d2a94f5b9_PATTERN = re.compile(r"/api/v1/edda/connector-config/string")
    EDDA_5bcc373fcfcd5bf69742d3d63dd6f92a_PATTERN = re.compile(r"/api/v1/edda/dictionary-references")
    EDDA_ed122b5ef64b5ecabe3526490589e041_PATTERN = re.compile(r"/api/v1/edda/test-connector")
    ...
    DEVICE_ADMINISTRATION_AUTHORIZATION_GLOBAL_EXCEPTION_RULES_4cb8a98ab3d456f387ad6ef911a7293f_PATTERN = re.compile(r"/api/v1/policy/device-admin/policy-set/global-exception/string")
    DEVICE_ADMINISTRATION_AUTHORIZATION_GLOBAL_EXCEPTION_RULES_593f723c1a3e533893ec03335e072cfe_PATTERN = re.compile(r"/api/v1/policy/device-admin/policy-set/global-exception/string")
    DEVICE_ADMINISTRATION_AUTHORIZATION_GLOBAL_EXCEPTION_RULES_ce3085eebdd15be7ac56b5970265d8df_PATTERN = re.compile(r"/api/v1/policy/device-admin/policy-set/global-exception/string")
    ...
    DEVICE_ADMINISTRATION_CONDITIONS_deec187b95c856a18b5483e89848dead_PATTERN = re.compile(r"/api/v1/policy/device-admin/condition/condition-by-name/string")
    DEVICE_ADMINISTRATION_CONDITIONS_087ba7985d7b5538a5ff14ec1f8aa4b1_PATTERN = re.compile(r"/api/v1/policy/device-admin/condition/condition-by-name/string")
    DEVICE_ADMINISTRATION_CONDITIONS_ff41f13f8b165c1e94aa1c555c92ddb5_PATTERN = re.compile(r"/api/v1/policy/device-admin/condition/condition-by-name/string")
    ...
    DEVICE_ADMINISTRATION_CONDITIONS_cc6dfd258c49529db4c580411afe868b_PATTERN = re.compile(r"/api/v1/policy/device-admin/condition/string")
    DEVICE_ADMINISTRATION_CONDITIONS_122ab05dc6105e47b391030a5fe50ecb_PATTERN = re.compile(r"/api/v1/policy/device-admin/condition/string")
    DEVICE_ADMINISTRATION_CONDITIONS_c638f98ea11b5c3882966cb0d1758a64_PATTERN = re.compile(r"/api/v1/policy/device-admin/condition/string")
    ...
    DEVICE_ADMINISTRATION_NETWORK_CONDITIONS_6a62af279ca25af0a1837f2cbf10a04d_PATTERN = re.compile(r"/api/v1/policy/device-admin/network-condition/string")
    DEVICE_ADMINISTRATION_NETWORK_CONDITIONS_c8acebd86a8151aeb2c17d973696fdfa_PATTERN = re.compile(r"/api/v1/policy/device-admin/network-condition/string")
    DEVICE_ADMINISTRATION_NETWORK_CONDITIONS_074e3c94fb105cd4a6eac4ace8c87f9f_PATTERN = re.compile(r"/api/v1/policy/device-admin/network-condition/string")
    ...
    def matches_EDDA_3c8f79c0801555878ad94493ade34587(self):
        return re.search(
            self.EDDA_3c8f79c0801555878ad94493ade34587_PATTERN,
            self.path
        )

    def edda_get_connector_config_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'response': [{'connector': {'additionalProperties': {}, 'attributes': {'attributeMapping': [{'dictionaryAttribute': 'string', 'includeInDictionary': True, 'jsonAttribute': 'string'}], 'bulkUniqueIdentifier': 'string', 'topLevelObject': 'string', 'uniqueIdentifier': 'string', 'versionIdentifier': 'string'}, 'connectorName': 'string', 'connectorType': 'string', 'deltasyncSchedule': {'interval': 0, 'intervalUnit': 'string', 'startDate': 'string'}, 'description': 'string', 'enabled': True, 'fullsyncSchedule': {'interval': 0, 'intervalUnit': 'string', 'startDate': 'string'}, 'protocol': 'string', 'skipCertificateValidations': True, 'url': {'accessKey': 'string', 'authenticationType': 'string', 'bulkUrl': 'string', 'clientId': 'string', 'clientSecret': 'string', 'incrementalUrl': 'string', 'password': 'string', 'refreshToken': 'string', 'tokenHeader': 'string', 'userName': 'string'}}}], 'version': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return

    def matches_EDDA_92c89285c31159faa2fb8abee25ce4a4(self):
        return re.search(
            self.EDDA_92c89285c31159faa2fb8abee25ce4a4_PATTERN,
            self.path
        )

    def edda_create_connector_config_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_EDDA_a3c21e5b61d95a0b9acf313e3ea03ad7(self):
        return re.search(
            self.EDDA_a3c21e5b61d95a0b9acf313e3ea03ad7_PATTERN,
            self.path
        )

    def edda_get_connector_config_by_connector_name_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_EDDA_7f5b69ccd0075b18a3de9e72b9e450cb(self):
        return re.search(
            self.EDDA_7f5b69ccd0075b18a3de9e72b9e450cb_PATTERN,
            self.path
        )

    def edda_update_connector_config_by_connector_name_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_EDDA_7011b1f3a77153ee82dca51d2a94f5b9(self):
        return re.search(
            self.EDDA_7011b1f3a77153ee82dca51d2a94f5b9_PATTERN,
            self.path
        )

    def edda_delete_connector_config_by_connector_name_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_EDDA_5bcc373fcfcd5bf69742d3d63dd6f92a(self):
        return re.search(
            self.EDDA_5bcc373fcfcd5bf69742d3d63dd6f92a_PATTERN,
            self.path
        )

    def edda_get_edda_dictionary_references_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_EDDA_ed122b5ef64b5ecabe3526490589e041(self):
        return re.search(
            self.EDDA_ed122b5ef64b5ecabe3526490589e041_PATTERN,
            self.path
        )

    def edda_test_connector_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'connectorName': 'string', 'data': 'string', 'error': 'string', 'status': 'string', 'uniqueID': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def subscriber_get_all_subscribers_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'nextPage': {'href': 'string', 'rel': 'string', 'type': 'string'}, 'previousPage': {'href': 'string', 'rel': 'string', 'type': 'string'}, 'response': [{'createTime': 'string', 'enabled': True, 'friendlyName': 'string', 'id': 'string', 'identityGroups': 'string', 'imeis': 'string', 'imsi': 'string', 'ki': 'string', 'link': {'href': 'string', 'rel': 'string', 'type': 'string'}, 'opc': 'string', 'updateTime': 'string'}], 'version': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def subscriber_create_subscriber_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'response': {'createTime': 'string', 'enabled': True, 'friendlyName': 'string', 'id': 'string', 'identityGroups': 'string', 'imeis': 'string', 'imsi': 'string', 'ki': 'string', 'link': {'href': 'string', 'rel': 'string', 'type': 'string'}, 'opc': 'string', 'updateTime': 'string'}, 'version': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def device_administration_conditions_get_device_admin_conditions_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'response': [{'conditionType': 'string', 'isNegate': True, 'link': {'href': 'string', 'rel': 'string', 'type': 'string'}}], 'version': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def matches_DEVICE_ADMINISTRATION_CONDITIONS_deec187b95c856a18b5483e89848dead(self):
        return re.search(
            self.DEVICE_ADMINISTRATION_CONDITIONS_deec187b95c856a18b5483e89848dead_PATTERN,
            self.path
        )
    ...
    def matches_DEVICE_ADMINISTRATION_CONDITIONS_087ba7985d7b5538a5ff14ec1f8aa4b1(self):
        return re.search(
            self.DEVICE_ADMINISTRATION_CONDITIONS_087ba7985d7b5538a5ff14ec1f8aa4b1_PATTERN,
            self.path
        )
    ...
    def matches_DEVICE_ADMINISTRATION_CONDITIONS_ff41f13f8b165c1e94aa1c555c92ddb5(self):
        return re.search(
            self.DEVICE_ADMINISTRATION_CONDITIONS_ff41f13f8b165c1e94aa1c555c92ddb5_PATTERN,
            self.path
        )
    ...
    def device_administration_network_conditions_get_device_admin_network_conditions_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'response': [{'conditionType': 'string', 'description': 'string', 'id': 'string', 'link': {'href': 'string', 'rel': 'string', 'type': 'string'}, 'name': 'string'}], 'version': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def do_GET(self):
        ...
        if self.matches_EDDA_3c8f79c0801555878ad94493ade34587():
            self.edda_get_connector_config_response()
            return

        if self.matches_EDDA_a3c21e5b61d95a0b9acf313e3ea03ad7():
            self.edda_get_connector_config_by_connector_name_response()
            return

        if self.matches_EDDA_5bcc373fcfcd5bf69742d3d63dd6f92a():
            self.edda_get_edda_dictionary_references_response()
            return
        ...
        if self.matches_DEVICE_ADMINISTRATION_CONDITIONS_deec187b95c856a18b5483e89848dead():
    ...
    def do_POST(self):
        ...
        if self.matches_EDDA_92c89285c31159faa2fb8abee25ce4a4():
            self.edda_create_connector_config_response()
            return

        if self.matches_EDDA_ed122b5ef64b5ecabe3526490589e041():
            self.edda_test_connector_response()
            return
    ...
    def do_PUT(self):
        ...
        if self.matches_EDDA_7f5b69ccd0075b18a3de9e72b9e450cb():
            self.edda_update_connector_config_by_connector_name_response()
            return
        ...
        if self.matches_DEVICE_ADMINISTRATION_CONDITIONS_087ba7985d7b5538a5ff14ec1f8aa4b1():
    ...
    def do_DELETE(self):
        ...
        if self.matches_EDDA_7011b1f3a77153ee82dca51d2a94f5b9():
            self.edda_delete_connector_config_by_connector_name_response()
            return
        ...
        if self.matches_DEVICE_ADMINISTRATION_CONDITIONS_ff41f13f8b165c1e94aa1c555c92ddb5():
